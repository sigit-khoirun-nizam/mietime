    ...
    <div class="container">
        <div class="w-full pt-10">
            <div class="flex items-center justify-center mb-5">
                <!-- Youtube -->
                <a href="https://wa.link/58sapl"
                target="_blank" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border text-slate-300 border-slate-300 hover:border-red-500 hover:bg-red-500 hover:text-white">
                ...
                <!-- Instagram -->
                <a href="https://www.instagram.com/mietime_simo/"
                target="_blank" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border text-slate-300 border-slate-300 hover:border-red-500 hover:bg-red-500 hover:text-white">
            ...
            <p class="font-medium text-xs text-slate-500 text-center">&copy; Copyright by <span class="font-bold text-red-500">Mie Time Simo</span> 2023
            </p>
        </div>
    </div>
</footer>
