<x-app-layout>
        ...
        <script>
            ...
            var datatable = $('#crudTable').DataTable({
                ...
                columns: [
                    ...
                    { data: 'menu.price', name: 'menu.price' }
                ]
            })
        </script>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden rounded shadow mb-10">
                <div class="p-6 bg-white border-b border-gray-200">
                    <table class="table-auto w-full">
                        <tbody>
                            ...
                            <tr>
                                <th class="border px-6 py-4 text-right">Reservasi</th>
                                <td class="border px-6 py-4">{{ $transaction->res_date }}</td>
                            </tr>
                            <tr>
